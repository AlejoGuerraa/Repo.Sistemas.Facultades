...
export default function GhostHunter() {
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        console.error("GhostHunter load error:", err);
  ...
  return (
    <div className="ghost-root">
      ...
      <style>{`
        .ghost-main { max-width: 1100px; margin: 22px auto; padding: 16px; }
